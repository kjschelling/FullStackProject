...
var config = {
  apiOrigins: {
    ...
    production: 'https://sheltered-brushlands-74047.herokuapp.com/'
  }
};
...
var mannApi = __webpack_require__(7);
var mannUI = __webpack_require__(17);
...
var onCreate = function onCreate(event) {
  ...
  mannApi.createModel(data).then(mannUI.createSuccess).catch(mannUI.createFailure);
};
...
var onShow = function onShow() {
  ...
  mannApi.showModels().then(mannUI.showSuccess).catch(mannUI.showFailure);
};
...
var onUpdate = function onUpdate(event) {
  ...
  // console.log(data)
  event.preventDefault();
  mannApi.updateModel(data).then(mannUI.updateSuccess).catch(mannUI.updateFailure);
};

var onDelete = function onDelete(event) {
  var data = getFormFields(this);
  event.preventDefault();
  mannApi.deleteModel(data).then(mannUI.deleteSuccess).catch(mannUI.deleteFailure);
};
...
var showModels = function showModels() {
  return $.ajax({
    url: config.apiOrigin + '/mannequins',
    method: 'GET',
    headers: {
...
var deleteModel = function deleteModel(data) {
  return $.ajax({
    url: config.apiOrigin + '/mannequins/' + data.mannequin.id,
    method: 'DELETE',
    headers: {
...
var mannEvents = __webpack_require__(6);
...
var authUI = __webpack_require__(16);
var getFormFields = __webpack_require__(9);
...
var clearPass = function clearPass() {
  $('#new-password').val('');
  $('#old-password').val('');
};
...
var mannAPI = __webpack_require__(7);
var showModelsTemplate = __webpack_require__(18);
// clear form function
...
var clearDelete = function clearDelete() {
  $('#delete-id').val('');
};
...
var createSuccess = function createSuccess() {
  // console.log(data)
  $('#show-models').empty();
  mannAPI.showModels().then(showSuccess).catch(showFailure);
...
var showSuccess = function showSuccess(data) {
  ...
  // this function
  var showModelsHtml = showModelsTemplate({ mannequins: data.mannequins });
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n   <!-- Developers, why are we using data-id and not just id? -->\n   <ul data-id=\""
    ...
    + "</small></li>\n     <li> <small>Last: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.surname : stack1), depth0))
    + "</small></li>\n     <li> <small>Measurements: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.measurements : stack1), depth0))
    + "</small></li>\n     <li> <small>Eye Color: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.eye_color : stack1), depth0))
    + "</small></li>\n     <li> <small>Hair Color: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.hair_color : stack1), depth0))
    + "</small></li>\n     <li> <small>Hair Length: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.hair_length : stack1), depth0))
    + "</small></li>\n     <li> <small>Gender: "
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.mannequins : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
